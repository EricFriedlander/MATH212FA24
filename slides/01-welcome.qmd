...
Navigate to [Canvas](https://cofi.instructure.com/courses/15692/discussion_topics/64816) and answer the survey questions. Note that your answers will not be visible by anyone but myself.
...
-   **Course website**: [sta210-fa23.netlify.app](https://mat212fa24.netlify.app/)
...
-   No late work is accepted for application exercises, since these are designed as in-class activities to help you prepare for labs and homework. If you are absent for a school-sponsored event or illness, you will be allowed to submit the exercise outside of class hours, no later than the start of the next class
