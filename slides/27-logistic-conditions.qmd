...
1. Design a simulation-based hypothesis test to determine whether your predictor is a useful. Your answer should include a step by step guide of how to implement the test.
2. Design a simulation-based procedure for constructing a confidence interval for the coefficient of your assigned predictor.
