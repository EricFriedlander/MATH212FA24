...
If you are computing your evaluation metrics (e.g. $R^2$ or RMSE), you should use transform you predictions BACK to their original scale, especially if you're trying to choose the best model
