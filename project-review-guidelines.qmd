...
It will be helpful, after having a few days away from your paper, to review it using the ["Revising Guide"](https://cofi.instructure.com/courses/15692/assignments/200729).  Try to look at it with fresh eyes.  Read it aloud.  
Convince a friend/significant other/family member to listen to you read it.  Encourage them to interrupt you when they don’t understand something or the writing is unclear.  Interrupt yourself when you don’t understand something or the writing is unclear.  
Make notes to yourself about changes you should make: things you should add or delete from the paper, ways to make it more clear or more concise, etc.  (You may not want to start making those changes until you read the professor and peer feedback.)
