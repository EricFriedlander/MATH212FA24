---
title: "AE 23: Multiple Logistic Regression"
editor: visual
execute: 
  warning: false
  message: false
...
::: callout-important
-   Open [RStudio](https://rstudio.collegeofidaho.edu/) and create a subfolder in your AE folder called "AE-23".

-   Go to the [Canvas](https://cofi.instructure.com/courses/15692/assignments/200726) and locate your `AE-23` assignment to get started.

-   Upload the `ae-23.qmd` and `framingham.csv` files into the folder you just created. The `.qmd` and PDF responses are due in Canvas. You can check the due date on the Canvas assignment.
:::
...
4. On the white board, write the null and alternative hypotheses (in both symbols and words), the test statistic, the p-value on the board.
5 What is the conclusion of your test in context?
