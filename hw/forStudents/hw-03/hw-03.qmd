...
- Log into [Canvas](https://cofi.instructure.com/courses/15692/assignments/181930), navigate to Homework 3 and upload the `hw-03.qmd` and `coffee-grades.csv` file into the folder your just made.
