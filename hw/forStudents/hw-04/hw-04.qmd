...
- Log into [Canvas](https://cofi.instructure.com/courses/15692/assignments/182331), navigate to Homework 4 and upload the `hw-04.qmd` and `alumni-salaries.csv` file into the folder your just made.
...
```{r}
alumni <- read_csv("alumni-salaries.csv")
```
...
[^2]: The "Workflow & formatting" grade is to assess the reproducible workflow and overall readability.
