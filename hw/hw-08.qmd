...
-   Log into [Canvas](https://cofi.instructure.com/courses/15692/assignments/183937), navigate to Homework 8 and upload the `hw-08.qmd` and `lego-sample.csv` files into the folder your just made.
