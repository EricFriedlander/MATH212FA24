...
slow down for really big data; if you have a truly humongous data set
...
A rubric can be found [here](/project-instructions.html) and poster template can be found on Canvas.
